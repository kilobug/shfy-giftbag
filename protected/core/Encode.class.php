...
class Encode {
	static function reversibleEncode($string, $key = '', $expiry = 0) {
		return self::reversible($string, 'ENCODE', $key, $expiry);
	}
	
	static function reversibleDecode($string) {
		return self::reversible($string, 'DECODE');
	}
